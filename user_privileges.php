                                 ...
                                 <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <a type="button" class="btn btn-info btn-sm" href="privileges-form.php" style="float: right;"><i class="fas fa-plus"></i> Add Privilege</a>
...
<div onscroll='scroller("scrollme", "scroller")' id="scrollme">
  <table id="multi_col_order" width="450">
     ...
     <tbody>
                     ...
                     <?php $sql2 = "SELECT * FROM ev_privileges ORDER BY privileges_name ASC";
                   ...
                   <tr>
                                        ...
                                        <td></td>
                                        <td id="status"><?php echo $row2['privileges_name'];?></td>
                                        
                                        <td id="status">
											<a href="privileges-form.php?privilage_id=<?php echo $row2['privilage_id']; ?>" class="btn btn-info btn-sm">Edit</a>
											
											<a href="user_privileges.php?del=<?php echo $row2['privilage_id']; ?>" class="btn btn-danger btn-sm" onClick="return confirm('Do you really want to remove it?')">Delete</a>
					   </td>
                                    </tr>
