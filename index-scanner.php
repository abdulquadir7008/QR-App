...
if ($_SESSION['id']) {
   ...
   // Get the current date and time
    ...
    // Set the global session value for session time
    $_SESSION['session_time'] = $log_time;
  
    echo '<script type="text/javascript">
           window.location = "' . $domain_url . 'qr-scanner.php";
         </script>';
}
    ...
    <div class="auth-box row">
      ...
      <div class="col-lg-5 col-md-7 bg-white">
        ...
        <div class="p-3">
          ...
          <form class="mt-4" action="script/login_proccess_scanner.php" method="POST">
            <div class="row">
              <div class="col-lg-12">
